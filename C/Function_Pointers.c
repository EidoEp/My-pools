...
The first question that may come to your mind is why would we use pointers to call a 
function when we can simply call a function by its name: function(); - that's a great question! Now imagine the sort 
function where you need to sort an array. Sometimes you want to order array elements in an ascending 
order or descending order. How would you choose? Function pointers!
...
Read it inside-out; 
    ...
    - And finally int is the argument type of that function. 
Got it? Good.
